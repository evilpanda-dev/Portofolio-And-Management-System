          ...
          >
            ...
            {formik => {
                return (
                  ...
                  value={FirstName}
                onChange={(e) => {setFirstName(e.target.value); formik.handleChange(e)}}
                />
                        </div>
                        <div>
                            <FormikControl
                  ...
                  value={LastName}
                onChange={(e) => {setLastName(e.target.value); formik.handleChange(e)}}
                />
                        </div>
                        <div>
                            <FormikControl
                  ...
                  value={BirthDate}
                onChange={(e) => {setBirthDate(e.target.value); formik.handleChange(e)}}
                />
                        </div>
                        <div>
                            <FormikControl
                  ...
                  value={Address}
                onChange={(e) => {setAddress(e.target.value); formik.handleChange(e)}}
                />
                        </div>
                        <div>
                            <FormikControl
                  ...
                  value={City}
                onChange={(e) => {setCity(e.target.value); formik.handleChange(e)}}
                />
                        </div>
                        <div>
                            <FormikControl
                  ...
                  value={Country}
                onChange={(e) => {setCountry(e.target.value); formik.handleChange(e)}}
                />
                        </div>
                        <div>
                            <FormikControl
                ...
                />
                  ...
                  value={AboutMe}
                onChange={(e) => {setAboutMe(e.target.value); formik.handleChange(e)}}
                />
                        </div>
                        <div>
                        <FormikControl
                  ...
                  name='Avatar'
                onChange={(e) => {setAvatar(e.target.files[0]); formik.handleChange(e); setAvatarPreview(URL.createObjectURL(e.target.files[0]))}}
                />
                </div>
                <img  width={"250px"} src={AvatarPreview} />

                <div>
                          <button type='submit' disabled={!formik.isValid} onClick={onSubmit}>Update</button>
                          </div>
                    </div>
                )
            }}
