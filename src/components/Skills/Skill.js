    ...
    <>
      <section id="skills">
        ...
        <div className='openEditButton'>
          <button className="openEdit" onClick={changeButtonState}><i className='openEditIcon'><FontAwesomeIcon icon={solid('pen-to-square')} /></i><span>Open edit</span></button>
        </div>
              ...
              <div className='skillDataWrapper'>
                <form id='skillForm'>
                  <div className='nameWrapper'>
                    <label htmlFor="type" className='skillLabel'>Skill name: </label>
                    <input
                      id='type'
                      name='name'
                      type='text'
                      ...
                      value={type}
                      onChange={(e) => { setType(e.target.value); formik.handleChange(e) }}
                  ...
                  <div className='rangeWrapper'>
                    <label htmlFor="level" className='skillLabel'>Skill range: </label>
                    <input
                      id='level'
                      name='range'
                      type='text'
                      ...
                      value={range}
                      onChange={(e) => { setRange(e.target.value); formik.handleChange(e) }}
                      className='skillInput'
                      style={getStyles(formik.errors, 'range')} />
                    {formik.errors.range ? <div className='errorMessage'>{formik.errors.range}</div> : null}
                  </div>

                  <button type='submit' onClick={handleAction} disabled={!formik.dirty || !formik.isValid} className='submitButton'>Add skill</button>
            ...
            <div>
              <ul className="skills">
                {skillList.map((skill) =>
                  ...
                  >
                    <p>{skill.skills.name}<span></span></p>
                  </li>
                )}
              </ul>
