      ...
      <section id="contacts">
        ...
        <div className="contactMethod">
          ...
          <div className="contactWrapper">
            <a href="tel:500-342-242" className="contactData">
              500 342 242
            </a>
          </div>
        </div>
        ...
        <div className="contactMethod">
          ...
          <div className="contactWrapper">
            <a href="mailto:office@kamsolutions.pl" className="contactData">
        ...
        <div className="contactMethod">
          ...
          <div className="contactWrapper">
            ...
            <a href="https://twitter.com/wordpress" className="contactLinks">
              {" "}
        ...
        <div className="contactMethod">
          ...
          <div className="contactWrapper">
            ...
            <a href="skype:kamsolutions.pl" className="contactLinks">
              kamsolutions.pl
            </a>
          </div>
        </div>
